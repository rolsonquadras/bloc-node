...
function recordChannelCacheResult {
    declare FIXTURES_TREE_CHANNEL=$(ls -R test/bddtests/fabric/fixtures/fabric/channel)
...
function recordCryptoCacheResult {
    declare FIXTURES_TREE_CRYPTO=$(ls -R test/bddtests/fabric/fixtures/fabric/crypto-config)
...
function isCryptoFixturesCurrent {
    if [ ! -d "test/bddtests/fabric/fixtures/fabric/crypto-config" ]; then
    ...
    declare FIXTURES_TREE=$(ls -R test/bddtests/fabric/fixtures/fabric/crypto-config)
...
function isChannelFixturesCurrent {
    if [ ! -d "test/bddtests/fabric/fixtures/fabric/channel" ]; then
    ...
    declare FIXTURES_TREE=$(ls -R test/bddtests/fabric/fixtures/fabric/channel)
